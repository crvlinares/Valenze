# Política de Privacidad y Términos de Uso - Valenze Bot

**Última actualización:** Junio 2026

En **Valenze** respetamos tu privacidad y cumplimos con la normativa peruana vigente, específicamente la **Ley N° 29733 (Ley de Protección de Datos Personales)** y su Reglamento.

## 1. ¿Qué datos recopilamos?
Cuando utilizas Valenze a través de Telegram, recopilamos única y exclusivamente:
...
Hemos diseñado Valenze bajo una arquitectura de "Confianza Cero" (Zero-Trust). 
- Los datos se almacenan en servidores seguros (PostgreSQL) con políticas estrictas de seguridad a nivel de fila (RLS). 
- Nadie, ni siquiera los desarrolladores de Valenze, puede acceder a tus registros financieros gracias a que el sistema requiere una firma criptográfica (JWT) generada dinámicamente desde tu cuenta de Telegram.
